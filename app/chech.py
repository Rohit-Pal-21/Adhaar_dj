...
# langs_list = MyMemoryTranslator().get_supported_languages()
# langs_list
# """
...
x = """ Passage describes the act of passing or traveling from one place to the next. People often use the word passage to specifically refer to a journey by ship, as in, "The passage to America was long and hard." A section of written work or music can also be called a passage. """
for i in range(0,10000) :
     
    translated = GoogleTranslator(source='en', target='mr').translate(x)
    print( i ,translated)
...
# for i in arr : 
#     x = translator.translate(text= i , dest='mr').text
#     print(x)

# translations = translator.translate(['The quick brown fox', 'jumps over', 'the lazy dog'], dest='mr')
